...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO collections 
        (year_level, major, student_name, membership_fee, acquaintance_contribution, sportsfest_contribution, sanction, school_year) 
        VALUES 
        ('$year_level', '$major', '$student_name', $membership_fee, $acquaintance_contribution, $sportsfest_contribution, $sanction, '$school_year')";
        ...
        <form class="mb-3" method="post">
            ...
            <div class="row">
                <div class="mb-3 col-md-6">
                    ...
                    <input type="number" step="0.01" name="membership_fee" class="form-control" required>
                </div>
                <div class="mb-3 col-md-6">
                    <label class="form-label">Acquaintance Contribution (₱)</label>
                    <input type="number" step="0.01" name="acquaintance_contribution" class="form-control" required>
                </div>
            </div>
            <div class="row">
                <div class="mb-3 col-md-6">
                    <label class="form-label">Sportsfest Contribution (₱)</label>
                    <input type="number" step="0.01" name="sportsfest_contribution" class="form-control" required>
                </div>
                <div class="mb-3 col-md-6">
                    <label class="form-label">Sanction (₱)</label>
                    <input type="number" step="0.01" name="sanction" class="form-control" required>
                </div>
            </div>
            <div class="mb-3">
